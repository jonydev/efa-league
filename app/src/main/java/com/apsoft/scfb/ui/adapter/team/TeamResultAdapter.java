...
public class TeamResultAdapter extends BaseAdapter {
    ...
    public TeamResultAdapter(Context ctx) {
        context = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_not_start_game = (TextView) convertView.findViewById(R.id.tv_not_start_game);
            holder.tv_time = (TextView) convertView.findViewById(R.id.tv_time);
            holder.tv_detail_time = (TextView) convertView.findViewById(R.id.tv_detail_time);
            holder.tv_detail_place = (TextView) convertView.findViewById(R.id.tv_detail_place);
        ...
        ImageLoader1.getInstance().displayImage(context, schedule.getHome_team_image(), holder.iv_teamflag_left);
        ImageLoader1.getInstance().displayImage(context, schedule.getAway_team_image(), holder.iv_teamflag_right);
